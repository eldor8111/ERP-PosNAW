        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm">
            ...
            <div className="text-slate-600 text-sm mt-3 pt-3 border-t border-slate-100">
              Umumiy summa: <span className="font-bold text-lg text-red-500">{fmt(data.summary.umumiy)}</span>
            </div>
          </div>
          <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm">
            <h3 className="text-slate-500 text-sm font-semibold mb-3">Ta'minotchiga to'lovlar summasi</h3>
            <div className="text-slate-600 text-sm mt-3 pt-3 border-t border-slate-100">
              Umumiy summa: <span className="font-bold text-lg text-amber-600">{fmt(data.summary.taminotchi_qarz_yopish)}</span>
            </div>
          </div>
          <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm">
            <h3 className="text-slate-500 text-sm font-semibold mb-3">Xarajatlar summasi</h3>
            <div className="text-slate-600 text-sm mt-3 pt-3 border-t border-slate-100">
              Umumiy summa: <span className="font-bold text-lg text-red-600">{fmt(data.summary.xarajat)}</span>
            </div>
          </div>
          <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm">
            <h3 className="text-slate-500 text-sm font-semibold mb-3">Mijozga qaytaruv to'lovlari</h3>
            <div className="text-slate-600 text-sm mt-3 pt-3 border-t border-slate-100">
              Umumiy summa: <span className="font-bold text-lg text-indigo-600">{fmt(data.summary.mijozga_qaytaruv)}</span>
            </div>
          </div>
        </div>
      )}
