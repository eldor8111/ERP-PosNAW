...
export const ROLE_GROUPS = {
  ...
  // Chakana POS kassaga kirish — faqat admin/direktor/menejer
  POS_ACCESS: [ROLES.ADMIN, ROLES.DIRECTOR, ROLES.MANAGER],
  // Faqat yuqori boshqaruv
  MANAGEMENT: [ROLES.ADMIN, ROLES.DIRECTOR],
  // Savdo va mijozlar — kassir ham kiradi (ulgurji sotuv)
  SALES: [ROLES.ADMIN, ROLES.DIRECTOR, ROLES.MANAGER, ROLES.CASHIER],
  // Ombor boshqaruvi
  WAREHOUSE_ACCESS: [ROLES.ADMIN, ROLES.DIRECTOR, ROLES.MANAGER, ROLES.WAREHOUSE, ROLES.CASHIER],
