...
def expenses_report(
    ...
    return {
        ...
        "items": [
            {
                "id": e.id,
                "category": e.category.name if e.category else "вЂ”",
    ...
    return [
        {
            ...
            "product_name": r.name,
            "sku": r.sku,
            "category_name": r.category_name or "вЂ”",
...
def customer_debts_report(
    ...
    """Debitor qarzdorlik вЂ” mijozlar bo'yicha"""
...
def supplier_debts_report(
    ...
    """Kreditor qarzdorlik вЂ” supplierlar bo'yicha"""
