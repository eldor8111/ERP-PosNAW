from sqlalchemy import Column, Integer, String, Boolean, Numeric, ForeignKey, DateTime, func  # type: ignore
...
class CurrencyRate(Base):
    ...
    currency = Column(String(10), nullable=False)          # e.g. "USD"
    updated_history = Column(JSONB, default=list, nullable=False, server_default="[]")