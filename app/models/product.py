...
class Product(Base):
    ...
    cost_price = Column(Numeric(16, 4), nullable=False, default=0)
    cost_currency = Column(String(3), nullable=False, server_default="UZS", default='UZS')
    wholesale_price = Column(Numeric(16, 4), nullable=True, default=None)
    wholesale_currency = Column(String(3), nullable=False, server_default="UZS", default='UZS')
    sale_price = Column(Numeric(16, 4), nullable=False, default=0)
