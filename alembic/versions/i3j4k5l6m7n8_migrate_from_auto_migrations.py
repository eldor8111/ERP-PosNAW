...
def downgrade():
    ...
    op.execute("DROP TABLE IF EXISTS wallet_balances")
    op.execute("DROP TABLE IF EXISTS sale_payments")

    op.execute("ALTER TABLE sales DROP COLUMN IF EXISTS paid_cashback")
    op.execute("ALTER TABLE sales DROP COLUMN IF EXISTS paid_card")
    op.execute("ALTER TABLE sales DROP COLUMN IF EXISTS paid_cash")
    op.execute("ALTER TABLE sales DROP COLUMN IF EXISTS discount_amount")
    op.execute("ALTER TABLE sales DROP COLUMN IF EXISTS currency_id")
    op.execute("ALTER TABLE sales DROP COLUMN IF EXISTS exchange_rate")
    op.execute("ALTER TABLE sales DROP COLUMN IF EXISTS loyalty_points_used")
    op.execute("ALTER TABLE sales DROP COLUMN IF EXISTS loyalty_points_earned")
    op.execute("ALTER TABLE sales DROP COLUMN IF EXISTS debt_due_date")

    op.execute("ALTER TABLE transactions DROP COLUMN IF EXISTS payment_type")
    op.execute("ALTER TABLE purchase_orders DROP COLUMN IF EXISTS discount_amount")
    op.execute("ALTER TABLE purchase_orders DROP COLUMN IF EXISTS paid_amount")
    op.execute("ALTER TABLE products DROP COLUMN IF EXISTS extra_product_codes")
    op.execute("DROP INDEX IF EXISTS ix_products_product_code")
    op.execute("ALTER TABLE products DROP COLUMN IF EXISTS product_code")
