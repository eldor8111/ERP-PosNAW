...
def downgrade() -> None:
    ...
    op.execute("DROP INDEX IF EXISTS ix_shifts_id")
    op.execute("DROP TABLE IF EXISTS shifts")
    op.execute("DROP INDEX IF EXISTS ix_expenses_id")
    op.execute("DROP TABLE IF EXISTS expenses")
    op.execute("DROP INDEX IF EXISTS ix_expense_categories_id")
    ...
    op.execute("DROP INDEX IF EXISTS ix_branches_id")
