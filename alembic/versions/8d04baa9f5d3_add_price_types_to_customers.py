...
Revision ID: 8d04baa9f5d3
Revises: 85c3e473542f
Create Date: 2026-06-08 15:23:05.790193
...
revision: str = '8d04baa9f5d3'
down_revision: Union[str, None] = '85c3e473542f'
...
def upgrade() -> None:
    ...
    if not _col(conn, 'customers', 'price_types'):
        op.add_column('customers', sa.Column('price_types', sa.Integer(), nullable=True))
