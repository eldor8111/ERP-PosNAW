...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.execute("DROP INDEX IF EXISTS ix_stock_movements_id")
    op.execute("DROP TABLE IF EXISTS stock_movements")
    op.execute("DROP INDEX IF EXISTS ix_stock_levels_id")
    op.execute("DROP TABLE IF EXISTS stock_levels")
    op.execute("DROP INDEX IF EXISTS ix_sale_items_id")
    op.execute("DROP TABLE IF EXISTS sale_items")
    op.execute("DROP INDEX IF EXISTS ix_sales_number")
    op.execute("DROP INDEX IF EXISTS ix_sales_id")
    op.execute("DROP TABLE IF EXISTS sales")
    op.execute("DROP INDEX IF EXISTS ix_products_sku")
    op.execute("DROP INDEX IF EXISTS ix_products_id")
    ...
    op.execute("DROP INDEX IF EXISTS ix_categories_id")
