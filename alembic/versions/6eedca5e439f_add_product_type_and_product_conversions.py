...
def downgrade() -> None:
    ...
    op.execute("DROP INDEX IF EXISTS ix_product_conversions_source_product_id")
    op.execute("DROP INDEX IF EXISTS ix_product_conversions_sell_product_id")
    op.execute("DROP INDEX IF EXISTS ix_product_conversions_id")
    op.execute("DROP TABLE IF EXISTS product_conversions")
