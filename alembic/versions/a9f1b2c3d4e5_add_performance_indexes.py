...
def downgrade():
    op.execute("DROP INDEX IF EXISTS ix_sales_company_id")
    op.execute("DROP INDEX IF EXISTS ix_sales_created_at")
    op.execute("DROP INDEX IF EXISTS ix_sales_status")
    ...
    op.execute("DROP INDEX IF EXISTS ix_sales_company_created")
    op.execute("DROP INDEX IF EXISTS ix_products_company_id")
    op.execute("DROP INDEX IF EXISTS ix_products_is_deleted")
    op.execute("DROP INDEX IF EXISTS ix_products_status")
    op.execute("DROP INDEX IF EXISTS ix_products_category_id")
    op.execute("DROP INDEX IF EXISTS ix_stock_levels_warehouse_id")
    op.execute("DROP INDEX IF EXISTS ix_stock_levels_product_id")
    ...
    op.execute("DROP INDEX IF EXISTS ix_batches_product_id")
    op.execute("DROP INDEX IF EXISTS ix_batches_company_id")
    op.execute("DROP INDEX IF EXISTS ix_batches_warehouse_id")
